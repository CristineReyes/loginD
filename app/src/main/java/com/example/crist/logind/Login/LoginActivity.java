package com.example.crist.logind.Login;
...
import com.example.crist.logind.MainActivity;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (!TextUtils.isEmpty(password) && !password.equals("Diego2004")) {
        ...
        if (TextUtils.isEmpty(name)) {
            ...
            focusView = mNameView;
            cancel = true;
        } else if (!isNameValid(name) || !name.equals("Diego@") ) {
        ...
        if (cancel) {
            ...
            if (name.equals("Diego@") && password.equals("Diego2004")) {
